...
<head>
    ...
    <p Style="text-align:center;position:absolute;top:60px;left:35%;color: aqua;font-size: xx-large;"><b> Welcome to Student Information System </b></p>
</head>
<body class="bg">
     <form action="login_main.php" method="post">
        ...
        <h2 style="background-color:rgb(240, 225, 24);text-align:left;width:250px;"> student</h2>
...
<div class="line1" Style="position:absolute;left:50%;top:20%">
        ...
        <h2 style="background-color:rgb(233, 67, 150);text-align:left;width:250px;"> Admin</h2>
        <form action="login_main.php" method="post"> 
        <?php if (isset($_GET['error'])) { ?>
     		<p class="error"><?php echo $_GET['error']; ?></p>
     	<?php } ?>
